      ...
      <main className={styles.main}>
        ...
        <div className={styles.products}>
          {data && data.map((info, index) => {
            if (info.sex === filter && (info.category === category || info.category === "none")) {
              return (
                <div>
                  <Product key={index}
                    img={info.image}
                  ...
                  {
                    info.colours && info.colours.map((colour, ind) => {
                      return (
                        <Colours 
                          key={ind}
                          colours={colour}/>//need to call hex instead of colour
 ...
 *               {info.title}
              {
                info.colours && info.colours.map((colour, index) => {
